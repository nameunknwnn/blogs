...
export default async function Post({
  ...
  const pageData = await getSinglePosts(slug.postSlug);
  console.log("image           ",pageData.featuredImage);
  return (
    <>
      <Head>
        <title>{`${pageData.title} - Spencer Sharp`}</title>
        ...
        <div className="xl:relative">
          <div className="mx-auto max-w-2xl">
            ...
            <article>
              ...
              <FeatureImage post={pageData}></FeatureImage>
